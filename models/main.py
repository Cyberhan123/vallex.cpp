...
# from models.g2p import PhonemeBpeTokenizer
# from models.vallex import VALLE
from macros import  NUM_TEXT_TOKENS, N_DIM, NUM_HEAD, NUM_LAYERS, PREFIX_MODE, NUM_QUANTIZERS
...
text_tokenizer = PhonemeBpeTokenizer(tokenizer_path="./g2p/bpe_69.json")
...
checkpoint = torch.load(os.path.join("./vallex-checkpoint.pt"), map_location='cpu')
